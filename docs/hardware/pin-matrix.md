...
## Hardware Safety and Octal PSRAM Protection Filter
...
|---|---|---|
| **GPIO 33, 34, 35, 36, 37** | **LOCKED** | Dedicated high-speed Octal-SPI PSRAM and Quad Flash bus. Rewiring causes immediate crash. |
| **GPIO 19, 20** | **RESERVED** | Native USB D+/D- and JTAG debugging lines. |
| **GPIO 45, 46** | **STRAPPING** | Boot voltage / VDD_SPI strapping pins. |
