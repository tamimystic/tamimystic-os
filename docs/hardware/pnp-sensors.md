# Plug and Play Sensor and Actuator Catalog

Tamimystic OS includes an onboard **Plug and Play (PnP) Registry** containing hardware identification signatures for 15+ industry-standard I2C sensors and expansion modules.
...
graph TD
    ...
    MATCH -->|Yes| INIT["Auto-Configure Driver and Bind to Python API"]
...
| `0x76` / `0x77` | **BME280 / BMP280** | Environmental | High-precision Temperature, Humidity and Barometric Pressure | Weather station, drone altitude estimation |
...
| `0x57` | **MAX30102** | Biomedical | High-Sensitivity Optical Heart-Rate and SpO2 Sensor | Wearable health tracking, pulse monitoring |
