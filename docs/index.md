...
**Tamimystic OS** is a groundbreaking, full-stack edge robotics and artificial intelligence operating system designed specifically for the **ESP32-S3-N16R8** microcontroller (Xtensa® dual-core 32-bit LX7 @ 240MHz, 16MB Quad-SPI Flash, 8MB Octal-SPI PSRAM).
...
🌐 **GitHub Repository**: [github.com/tamimystic/tamimystic-os](https://github.com/tamimystic/tamimystic-os)  
📖 **Online Documentation**: [tamimystic.github.io/tamimystic-os](https://tamimystic.github.io/tamimystic-os/)
...
### 💡 The "Flash Once, Configure Infinitely" Revolution
...
| 🔌 **[Hardware & Pin Matrix](hardware/pin-matrix.md)** | Learn how runtime pin remapping works, Octal PSRAM protection, and view the 15+ Plug & Play sensor database. |
...
| 🧠 **[Edge AI & Vision](ai-vision/camera.md)** | High-speed DVP camera pipeline, PSRAM triple buffering, MobileNet models, and autonomous visual target tracking. |
| 🐍 **[Python & Web IDE](apps/micropython.md)** | MicroPython API reference (`tamimystic.*`), in-browser Web IDE, 6.8MB LittleFS Flash VFS, and Dual-Bank OTA. |
| 📖 **[API & CLI Reference](reference/cli.md)** | Comprehensive documentation of all serial CLI commands and HTTP REST endpoints with JSON payloads. |
| 🛠️ **[Developer Guide](development/build.md)** | Guide to compiling from source for physical ESP32-S3 or Native PC simulation (Windows/Linux). |

---

Ready to get started? Head straight to **[Getting Started → Flashing & Installation](getting-started/installation.md)**!
