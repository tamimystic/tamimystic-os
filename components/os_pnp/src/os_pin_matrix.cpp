...
void PinMatrixManager::init() {
    ...
    name_to_func = {
        ...
        {"motor_fl_pwm", PinFunction::MOTOR_FL_PWM},
        {"motor_fl_in1", PinFunction::MOTOR_FL_IN1},
        {"motor_fl_in2", PinFunction::MOTOR_FL_IN2},
        {"motor_fr_pwm", PinFunction::MOTOR_FR_PWM},
        {"motor_fr_in1", PinFunction::MOTOR_FR_IN1},
        {"motor_fr_in2", PinFunction::MOTOR_FR_IN2},
        {"motor_rl_pwm", PinFunction::MOTOR_RL_PWM},
        {"motor_rl_in1", PinFunction::MOTOR_RL_IN1},
        {"motor_rl_in2", PinFunction::MOTOR_RL_IN2},
        {"motor_rr_pwm", PinFunction::MOTOR_RR_PWM},
        {"motor_rr_in1", PinFunction::MOTOR_RR_IN1},
        {"motor_rr_in2", PinFunction::MOTOR_RR_IN2},
