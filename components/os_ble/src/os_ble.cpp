...
static const struct ble_gatt_svc_def gatt_svr_svcs[] = {
    {
        ...
        .uuid = BLE_UUID128_DECLARE(0x14, 0x12, 0x8a, 0x76, 0x04, 0xd1, 0x6c, 0x4f, 0x7e, 0x53, 0xf2, 0xe8, 0x00, 0x00, 0xb1, 0x19),
        .characteristics = (struct ble_gatt_chr_def[]) {
            {
                // Twist Characteristic (0xFF01)
                .uuid = BLE_UUID128_DECLARE(0x14, 0x12, 0x8a, 0x76, 0x04, 0xd1, 0x6c, 0x4f, 0x7e, 0x53, 0xf2, 0xe8, 0x01, 0x00, 0xb1, 0x19),
                .access_cb = gatt_svr_chr_access_robotics,
                .flags = BLE_GATT_CHR_F_WRITE | BLE_GATT_CHR_F_WRITE_NO_RSP,
            },
            {
                // Arm Characteristic (0xFF02)
                .uuid = BLE_UUID128_DECLARE(0x14, 0x12, 0x8a, 0x76, 0x04, 0xd1, 0x6c, 0x4f, 0x7e, 0x53, 0xf2, 0xe8, 0x02, 0x00, 0xb1, 0x19),
                .access_cb = gatt_svr_chr_access_robotics,
                .flags = BLE_GATT_CHR_F_WRITE,
            },
            {
                // Telemetry Characteristic (0xFF03)
                .uuid = BLE_UUID128_DECLARE(0x14, 0x12, 0x8a, 0x76, 0x04, 0xd1, 0x6c, 0x4f, 0x7e, 0x53, 0xf2, 0xe8, 0x03, 0x00, 0xb1, 0x19),
                .access_cb = gatt_svr_chr_access_robotics,
            ...
            },
            {
                ...
                .uuid = BLE_UUID128_DECLARE(0x14, 0x12, 0x8a, 0x76, 0x04, 0xd1, 0x6c, 0x4f, 0x7e, 0x53, 0xf2, 0xe8, 0x04, 0x00, 0xb1, 0x19),
                .access_cb = gatt_svr_chr_access_robotics,
            ...
            },
            {
                ...
                .uuid = BLE_UUID128_DECLARE(0x14, 0x12, 0x8a, 0x76, 0x04, 0xd1, 0x6c, 0x4f, 0x7e, 0x53, 0xf2, 0xe8, 0x05, 0x00, 0xb1, 0x19),
                .access_cb = gatt_svr_chr_access_robotics,
